...
import 'package:gitsuz/styles/app_palette.dart';
import 'package:gitsuz/styles/constants.dart';
...
class AppSettingsBloc extends Bloc<AppSettingsEvent, AppSettingsState> {
  ...
  FutureOr<void> _handleSettingsInitialization(InitAppSettings event, Emitter<AppSettingsState> emit) async {
  ...
  FutureOr<void> _handleThemeChange(ToggleTheme event, Emitter<AppSettingsState> emit) async {
