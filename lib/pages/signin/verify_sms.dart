...
import 'package:gitsuz/pages/signin/new_password.dart';
...
class VerifySmsPage extends StatelessWidget {
  ...
  static Route<void> route() {
    return MaterialPageRoute<void>(builder: (_) => const VerifySmsPage());
  }
          ...
          Column(
            children: [
              Padding(
                ...
                child: Center(child: Image.asset('assets/send_sms.png')),
              ),
              Padding(
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
          ...
          child: TextField(
            enabled: true,
            autocorrect: true,
            key: const Key('VerifySmsForm_emailInput_textField'),
            decoration: InputDecoration(
              ...
              // errorText: state.email.invalid ? null : 'invalid email or phone number',
            ),
          ),
        );
  }
